                        ...
                        <div className="space-y-6 justify-center">
                            <div className='flex items-center space-x-4'>
                                ...
                                <div>
                                    ...
                                    <a href="mailto:ananyadutta@gmail.com" className='text-muted-foreground hover:text-primary transition-colors'>
                                    ananyadutta@gmail.com
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className='flex items-center space-x-4'>
                                ...
                                <div>
                                    ...
                                    <a href="tel:+917908181955" className='text-muted-foreground hover:text-primary transition-colors'>
                                    +91 (7908181955)
                                    </a>
                                </div>
                            </div>
