...
const AboutMe = () => {
  return (
    <section id="about" className="py-34 px-4 relative">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className='space-y-6'>
              ...
              I have worked on various real-world projects using diverse technologies, 
              DevOps tools, and architectural designs, while adhering to the core principles of the SDLC phases.
              </p>

              <p className="text-muted-foreground">
                I'm passionate about creating elegant solution to complex problems,
            ...
            <div className='grid grid-cols-1 gap-6'>
              ...
              <div className='gradient-border p-6 card-hover'>
                <div className='flex items-start gap-4'>
                  ...
                  <div className="text-left">
                      <h4 className='font-semibold text-lg'>UI/UX Desgin</h4>
                      <p className='text-muted-foreground'>
              ...
              <div className='flex items-start gap-4'>
                  ...
                  <div className="text-left">
                      ...
                      <p className='text-muted-foreground'>
                        Leading projects from conception to completion with agile methodogies.
                      </p>
                  </div>
                </div>
              </div>
